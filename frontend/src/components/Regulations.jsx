                        ...
                        <tbody className="divide-y divide-gray-200">
                            {localRegulations.map((r) => {
                                const translateName = (name) => {
                                    const map = {
                                        'Age Regulation': 'Quy định tuổi',
                                        'Match Rules': 'Quy định trận đấu',
                                        'Goal Rules': 'Quy định bàn thắng',
                                        'Ranking Rules': 'Quy định xếp hạng',
                                    };
                                ...
                                <React.Fragment key={r._id}>
                                    <tr className="hover:bg-gray-50 transition-colors duration-150 cursor-pointer" onClick={() => toggleExpand(r._id)}>
                                        <td className="px-4 py-3 md:px-6 md:py-4 font-semibold text-gray-800">{translateName(r.regulation_name)}</td>
                                    </tr>
